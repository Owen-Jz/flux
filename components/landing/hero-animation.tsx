        ...
        <div className="relative w-full h-[400px] md:h-[600px] flex items-center justify-center overflow-visible perspective-2000">
            ...
            >
                <div className="h-10 border-b border-slate-100 bg-slate-50 flex items-center px-4 gap-2">
                    ...
                    <div className="w-2.5 h-2.5 rounded-full bg-slate-300" />
                    <div className="ml-2 w-20 h-2 bg-slate-200 rounded-full" />
                </div>
                <div className="p-5 space-y-4">
                    <div className="w-1/3 h-4 bg-slate-100 rounded" />
                    <div className="w-full h-8 bg-slate-50 border border-slate-100 rounded" />
                    <div className="w-full h-8 bg-slate-50 border border-slate-100 rounded" />
                    <div className="w-2/3 h-4 bg-slate-100 rounded mt-4" />
            ...
            >
                <div className="h-10 border-b border-slate-100 bg-slate-50 flex items-center px-4 gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-slate-300" />
                    <div className="ml-auto w-4 h-4 rounded text-slate-400">
            ...
            >
                ...
                >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-slate-900 drop-shadow-sm">
