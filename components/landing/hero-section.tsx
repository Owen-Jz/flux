...
import { ArrowRightIcon, PlayIcon, SparklesIcon, BoltIcon, ShieldCheckIcon, UsersIcon, ChartBarIcon, ChatBubbleLeftRightIcon, CheckIcon, ClockIcon } from "@heroicons/react/24/outline";
...
// Floating mini card with hover effects
function FloatingMiniCard({ delay, className, children }: { delay: number; className?: string; children: React.ReactNode }) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay, duration: 0.8, ease: [1.7, 0.3, 0.3, 1] }}
...
function FloatingDashboard({ scrollY }: { scrollY: MotionValue<number> }) {
  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-5xl mx-auto mt-16 lg:mt-24 perspective-1500">
      ...
      >
        <motion.div
          ...
          className="bg-white backdrop-blur-xl rounded-2xl border border-slate-200 p-4 shadow-2xl"
        >
      ...
      <motion.div
        ...
        className="relative z-10 bg-white dark:bg-slate-900/90 backdrop-blur-2xl rounded-2xl border border-slate-200/50 dark:border-slate-800 shadow-2xl"
      >
        ...
        <motion.div
          ...
          className="absolute -right-4 top-24 bg-white/95 backdrop-blur-xl p-3 rounded-2xl border border-slate-200/60 shadow-2xl flex items-center gap-3 z-20 cursor-pointer"
        >
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05, x: -5 }}
          className="absolute -left-4 bottom-24 bg-white/95 backdrop-blur-xl p-3 rounded-2xl border border-slate-200/60 shadow-2xl flex items-center gap-3 z-20 cursor-pointer"
        >
...
export function HeroSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[130vh] pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-white dark:bg-slate-950"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* Floating Dashboard Preview with enhanced animations */}
